...
signUp = driver.find_element_by_xpath("//a[@href = 'http://test.linuxjobber.com/Homes/selfstudy']").click()

time.sleep(1)

signUp = driver.find_element_by_xpath("//a[@href = 'http://test.linuxjobber.com/tryservices/package/standard']").click()
