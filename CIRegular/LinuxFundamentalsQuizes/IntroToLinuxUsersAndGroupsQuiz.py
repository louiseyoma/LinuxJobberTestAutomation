...
select_third_quiz = driver.find_element_by_xpath(".//*[@id='myList']/div[6]/div[3]/a/img").click()

#Start answering quiz questions

question1 = driver.find_element_by_xpath(".//*[@id='formId']/table/tbody/tr[2]/td[2]/ul/li[4]/input").click()
question2 = driver.find_element_by_xpath(".//*[@id='formId']/table/tbody/tr[3]/td[2]/ul/li[1]/input").click()
...
question5 = driver.find_element_by_xpath(".//*[@id='formId']/table/tbody/tr[6]/td[2]/ul/li[2]/input").click()
question6 = driver.find_element_by_xpath(".//*[@id='formId']/table/tbody/tr[7]/td[2]/ul/li[3]/input").click()
question7 = driver.find_element_by_xpath(".//*[@id='formId']/table/tbody/tr[8]/td[2]/ul/li[5]/input").click()
question8 = driver.find_element_by_xpath(".//*[@id='formId']/table/tbody/tr[9]/td[2]/ul/li[5]/input").click()
