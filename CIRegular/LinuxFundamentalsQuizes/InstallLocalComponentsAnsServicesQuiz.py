...
select_eight_quiz = driver.find_element_by_xpath(".//*[@id='myList']/div[10]/div[3]/a/img").click()
...
question5 = driver.find_element_by_xpath(".//*[@id='formId']/table/tbody/tr[6]/td[2]/ul/li[3]/input").click()
