...
select_second_quiz = driver.find_element_by_xpath(".//*[@id='myList']/div[4]/div[3]/a/img").click()
...
question5 = driver.find_element_by_xpath(".//*[@id='formId']/table/tbody/tr[6]/td[2]/ul/li[1]/input").click()
...
question8 = driver.find_element_by_xpath(".//*[@id='formId']/table/tbody/tr[9]/td[2]/ul/li[2]/input").click()
question9 = driver.find_element_by_xpath(".//*[@id='formId']/table/tbody/tr[10]/td[2]/ul/li[1]/input").click()
question10 = driver.find_element_by_xpath(".//*[@id='formId']/table/tbody/tr[11]/td[2]/ul/li[3]/input").click()
question11 = driver.find_element_by_xpath(".//*[@id='formId']/table/tbody/tr[12]/td[2]/ul/li[2]/input").click()
